...
from data import DIV2K, DetailNetDataLoader
from utils import *

parser = argparse.ArgumentParser(description='Semantic aware super-resolution')

parser.add_argument('--dataDir', default='/project/RDS-FEI-image_matting-RW/train/large_set', help='dataset directory')
parser.add_argument('--dataroot', default='/project/RDS-FEI-image_matting-RW/train/large_set', help='dataset directory')
...
def train(args):
	...
	dataloader = DetailNetDataLoader(args)
